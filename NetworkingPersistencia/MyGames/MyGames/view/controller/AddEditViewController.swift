...
class AddEditViewController: UIViewController {
    ...
    // o tipo Game ja foi criado pelo CoreData apos editar o arquivo do banco
    var game: Game!
    ...
    @objc func cancel() {
        // isso é para esconder o Picker View ou o teclado se tivesse
...
extension AddEditViewController: UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func numberOfComponents(in pickerView: UIPickerView) -> Int {
        return 1 // o valor 1 é porque só usamos apenas uma informacao para ser mostrada (ex. Nome da plataforma).
    }
